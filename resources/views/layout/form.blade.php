    ...
    <!-- FALCON CORE -->
    <link rel="stylesheet" href="{{ asset('falcon/vendors/bootstrap/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('falcon/css/theme.min.css') }}">
  ...
  preview.innerHTML = `
    <h2 style="text-align:center; letter-spacing:2px; margin-bottom:30px;">
